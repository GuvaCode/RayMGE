...
{$DEFINE FASTGEO_Single_PRECISION}
...
(* End of PolygonSegmentIntersect *)
 Function PntInPolygon(Px,Py:LongInt; NumPoly:LongInt; Var Poly: TPolygon2D):Boolean;
 Var I:LongInt;
     Orin:ShortInt;
 Begin
  PntInPolygon:=True;
  Orin:= Orientation(Poly[NumPoly].x,Poly[NumPoly].y,Poly[1].x,Poly[1].y,Px,Py);
  For I:= 1 to NumPoly-1 do If Orin <> Orientation(Poly[I].x,Poly[I].y,Poly[I+1].x,Poly[I+1].y,Px,Py) Then
      Begin
       PntInPolygon:=False;
       Break;
      End;
